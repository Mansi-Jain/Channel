...
$admin = new Admin($conn);
  ...
  if($all_bloggers === false)
  {
      ...
      echo '<tr>
      		<td><a href="deletepost.php?blogger_id='.$all_bloggers[$i][3].'">'.$all_bloggers[$i][0].'</a></td>
...
?>
    <?php
     $contacts = $admin->get_contacts();
     if($contacts === false)
     {
  	echo "<br><hr><div class='alert alert-info'>No Contacts...</div>";
     }
  else{
  	$i=0;
  	echo '<br><hr><h5 style="text-align: center;"><b>Contact List...</b></h5><br><div class="container"><table class="table table-striped"><thead><tr>
        <th>Name</th>
        <th>Email</th>
        <th>Message</th>
      </tr></thead><tbody>';
