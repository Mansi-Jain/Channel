...
if($blogs == false)
  {
    ...
    <div class="card sticky-action medium" style="border: thick solid #607d8b;">
    <div class="card-image  waves-effect waves-block waves-light">
              <img class = "activator" src="'.$viewer->get_blog_image($blogs[$i][0]).'">
            </div>
    <div class="card-content">
    <span class="card-title">'.$blogs[$i][2].'<p class="flow-text grey-text" style="font-size: 20px;">'.$blogs[$i][4].','.$blogs[$i][6];
